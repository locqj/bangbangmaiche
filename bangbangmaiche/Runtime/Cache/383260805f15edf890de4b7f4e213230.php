				...
				<div class="rmiddle">
					<table>
						<tr>
							...
							<td  style="width:12%">型号</td>
							<td  style="width:12%">颜色</td>
							<td style="width:10%">价格</td>
							<td  style="width:15%">照片</td>
							<td  style="width:18%">操作</td>
						</tr>
						<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
								<td  ><span name='id'><!-- <?php echo ($v["id"]); ?> --></span></td>
								<td  >
									<input readonly="true" type='text' name='comefrom' value='<?php echo ($v["comefrom"]); ?>'>
								</td>
								<td  >
									<input readonly="true"  type='text' name='logo' value='<?php echo ($v["logo"]); ?>'>
								</td>
								<td  >
									<input  readonly="true" type='text' name='size' value='<?php echo ($v["size"]); ?>'>
								</td>
								<td  >
									<input readonly="true"  type='text' name='color' value='<?php echo ($v["color"]); ?>'>
								</td>
								<td  >
									<input  readonly="true" type='text' name='prize' value='<?php echo ($v["price"]); ?>'>
								</td>
								<td  >
									<img src="<?php echo ($v["imageurl"]); ?>">
								</td>
								<td >
									<a href="http://xwj.565tech.com/Ucar/index.php?m=Shop&a=saveshopinfo&id=<?php echo ($v["id"]); ?>"><button>修改</button></a>
									<a href="http://xwj.565tech.com/Ucar/index.php?m=Shop&a=deleteshopinfo&id=<?php echo ($v["id"]); ?>"><button class="delete">删除</button></a>
