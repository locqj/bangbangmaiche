		...
		<div class="left float-left">
			...
			<div class="search">
				...
				<ul class="sr-context" id="one">
					<li><a href="http://xwj.565tech.com/Ucar/index.php?m=Wap&a=searchuser"  id="two">推荐用户</a></li>
			...
			<div >
				...
				<div class="right-context">
					<div class="rmiddle">
						<table>
							<tr>
								<td style="width:4%" class="xuhao ">序号</td>
								<td style="width:12%">推荐人</td>
								<!-- <td style="width:10%">联系方式</td> -->
								<td style="width:10%">客户</td>
								<td style="width:10%">联系方式</td>
								<td style="width:10%">客户需求型号</td>
								<td style="width:8%">管理员评分</td>
								<td style="width:17%">评论</td>
							</tr>
							<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="tb-context">
									...
									<td><?php echo ($v["adminjudge"]); ?></td>
								</tr><?php endforeach; endif; ?>
						<!-- 	<td colspan='8' align='center' style="padding:10px;font-weight:bold">
								<?php echo ($page); ?>
							</td> -->
							<tr>
