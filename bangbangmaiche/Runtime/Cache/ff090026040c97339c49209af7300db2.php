      ...
      <script type="text/javascript">
       $(function(){
            $('a').click(function(){
                  ...
                  var money=$('.money').val();
                  if(name==''||money==''){
                    var href = 'http://xwj.565tech.com/Ucar/index.php?m=Wxpay&a=actpayinfo';
                     $('a').attr('href',href);
                     alert('用户名或电话不能为空');

                  }else{

                  var href = "http://xwj.565tech.com/Ucar/index.php?m=Wxpay&a=actPay"+'&id1='+name+'&id2='+money;
                  $('a').attr('href',href);
...
<body style="background-color: #EEFFFF">
       ...
       <div class="container">
          ...
          <div style="width: 100%;text-align: center">
            <!-- <button> -->
               <a href="http://xwj.565tech.com/Ucar/index.php?m=Wxpay&a=actPay">提&nbsp;交</a>
             <!-- </button> -->
          </div>
       </div>
